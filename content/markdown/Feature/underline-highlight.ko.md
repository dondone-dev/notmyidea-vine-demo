...
이 테마는 밑줄 강조와 형광펜 효과를 위한 사용자 정의 CSS 클래스 `u-line` 과 `hl` 을 제공합니다.

이것은 일반 텍스트, <span class="u-line">이것은 밑줄 강조</span>입니다.
이것은 <span class="u-line u-line-blue">파란 밑줄</span>,
이것은 <span class="u-line u-line-violet">보라 밑줄</span>입니다.
...
이것은 <span class="hl hl-yellow">노란 형광</span>,
이것은 <span class="hl hl-green">초록 형광</span>,
이것은 <span class="hl hl-pink">분홍 형광</span>입니다.
...
이것은 <span class="hl hl-marker">마커 스타일 형광</span>, <span class="hl hl-marker hl-green">초록 마커</span>입니다.
