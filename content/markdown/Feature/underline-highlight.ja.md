...
これは通常のテキスト、<span class="u-line">これは下線による強調</span>です。
これは<span class="u-line u-line-blue">青い下線</span>、
これは<span class="u-line u-line-violet">紫の下線</span>です。
...
これは<span class="hl hl-yellow">黄色のハイライト</span>、
これは<span class="hl hl-green">緑のハイライト</span>、
これは<span class="hl hl-pink">ピンクのハイライト</span>です。
...
これは<span class="hl hl-marker">マーカー風のハイライト</span>、<span class="hl hl-marker hl-green">緑のマーカー</span>です。
